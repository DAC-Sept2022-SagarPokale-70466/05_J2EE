...
Ant disadvantages 
1.While using ant , project structure had to be defined in build.xml. Maven has a convention to place source code, compiled code etc. So no need to provide informationabout the project structure in pom.xml file.
...
Within that --  dependency defines a specific dependency.(eg : hibernate dependency,spring web) 
...
-> Maven Build Life Cycle What is it ?
