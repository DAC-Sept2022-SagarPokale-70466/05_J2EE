...
public class Servlet1 extends HttpServlet {
	...
	public Servlet1() {
//		Servlet will call only default constructor
		System.out.println("in def ctor : config : "+getServletConfig());//null
//		System.out.println("context "+getServletContext());//what will happen ? NULL POINTER
//		WC will create 
	}
	//add paramterized ctor
	public Servlet1(String mesg) {
		System.out.println("in paramterized ctor....");//will Never be invoked!!!!
	}
